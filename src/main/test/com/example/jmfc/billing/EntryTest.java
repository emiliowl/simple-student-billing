...
public class EntryTest {
	...
	public void shouldParseEntryParameterAndSendItAsTheSTUDENT_ID() throws InterruptedException {
		try {
			Process proc = Runtime.getRuntime().exec("java -cp bin/:" +
					"/Users/emiliowl/.m2/repository/com/expert/jmfc/jmfc/0.4-SNAPSHOT/jmfc-0.4-SNAPSHOT.jar " +
					"com.example.jmfc.billing.Entry 1234567");
			proc.waitFor();
	...
	public void shouldReceiveTheTranc1ContentAsResultForMFCall() throws InterruptedException {
		try {
			Process proc = Runtime.getRuntime().exec("java -cp bin/:" +
					"/Users/emiliowl/.m2/repository/com/expert/mf-communicator-mock/0.0.1-SNAPSHOT/mf-communicator-mock-0.0.1-SNAPSHOT.jar:" +
					"/Users/emiliowl/.m2/repository/com/expert/jmfc/jmfc/0.4-SNAPSHOT/jmfc-0.4-SNAPSHOT.jar " +
					"com.example.jmfc.billing.Entry 1234567");
			proc.waitFor();
			String result = getProcessSysout(proc);
	...
	public void shouldReceive123AndConvertTo0000123() throws InterruptedException {
		try {
			Process proc = Runtime.getRuntime().exec("java -cp bin/:" +
					"/Users/emiliowl/.m2/repository/com/expert/mf-communicator-mock/0.0.1-SNAPSHOT/mf-communicator-mock-0.0.1-SNAPSHOT.jar:" +
					"/Users/emiliowl/.m2/repository/com/expert/jmfc/jmfc/0.4-SNAPSHOT/jmfc-0.4-SNAPSHOT.jar " +
					"com.example.jmfc.billing.Entry 123");
			proc.waitFor();
			String result = getProcessSysout(proc);
